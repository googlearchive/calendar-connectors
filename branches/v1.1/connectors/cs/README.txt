...
1. Google Data (GData) API .NET Client Library and its dependencies
licensed under the Apache License, Version 2.0. 


Project: http://code.google.com/p/google-gdata/
License: http://www.apache.org/licenses/LICENSE-2.0



2. Apache log4net licensed under the Apache License, Version 2.0.

Project: http://logging.apache.org/log4net/index.html
License: http://logging.apache.org/log4net/license.html



3. tz4net v3.0.2.0 licensed under the GNU LGPL V2.
