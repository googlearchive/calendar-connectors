...
/**
 * basic test for GetDirectoryResponse
 */
public class GetDirectoryResponseTest extends TestCase {
  
  public void testClassDoesNotCrashEasily() {
    GetDirectoryResponse response = 
      new GetDirectoryResponse(new AdminCommand("", ""));
    response.renderResponse();
    response.addUser(new DsUser());
    response.renderResponse();
  }
